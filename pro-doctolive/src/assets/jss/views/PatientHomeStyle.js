...
import { 
  ...
  const profilePageStyle = {
    ...
    calltoActionContentWrap: {
        ...
        backgroundImage: `url(${require('assets/img/backgroundpoints.png')})`,
    ...
    header : {
        position: "relative",
        height: 456,
        background: "-webkit-linear-gradient(top, #0596de 19%, #10adde 100%)",
        background: "linear-gradient(180deg, #0596de 19%, #10adde 100%)",
        padding: "0 64px",
        display: "block"
    },
    backgroundZone : {
