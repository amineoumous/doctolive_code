        ...
        <Col md={6} lg={4} sm={8}>
          ...
          <div>
            ...
            <Card className="mr-2" body>
              ...
              <div className="mb-3">
                  ...
                  <a href="https://doctor.doctolive.ma" className="" >Rejoignez-nous</a>
                </div>
          </Card>
          <Card body className="ml-2">
            <div className="d-flex justify-content-center flex-column align-items-center" >
              ...
              <span className="">
                <span>Vous êtes patient et vous souhaitez prendre rendez-vous en ligne ?</span>
              </span>
              <a className="" href="https://doctolive.ma">Prendre RDV en ligne</a>
              </div>
          </Card>
              </div>
          </div>
