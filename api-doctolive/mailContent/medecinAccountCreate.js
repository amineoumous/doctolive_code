    ...
    module.exports = ( user, link) => {
        ...
        try {
            let mail = {
                header: `Bonjour`,
                title: `Confirmation de votre compte chez Doctolive`,
                sousTitre: "Utilisez ce lien pour confirmer votre compte",
                confirmAccount: "confirmer votre compte avec le lien suivant :",
                link: link,
                question: "Si vous avez des questions, visitez notre page de contact - nous sommes toujours heureux de vous aider.",
                linkToContact: "https://doctolive.ma/contact",
                appLink: "",
                contact: "contactez nous",
                conclusion: "",
                moreHelp: "Nous sommes là pour vous aider",
                websiteLink: "https://doctolive.ma",
            ...
            return `<html>
                        ...
                        <head>
                            <title>Confirmation de compte patient doctolive</title>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                                        ...
                                                        <tr>
                                                            <td bgcolor="#ffffff" align="center" style="padding: 10px 30px 40px 30px;">
                                                                <table style="border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <tr>
                                                                        <td bgcolor="#1746e0" align="left">
                                                                           <a href="${mail.link} "> <span style="font-size: 20px; cursor:pointer; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 15px 25px; border-radius: 2px; border: 1px solid #1746e0; display: inline-block;"> ${mail.confirmAccount}  </span> </a>
                                                                        </td>
                                                                    </tr>
                                                                    </tr>
                                                                </table>
                                            ...
                                            <tr>
                                                <td bgcolor="#ffffff" align="center" style="padding: 10px 30px 20px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                                    <p style="margin: 16px;">${mail.question}</p>
